# Domain Knowledge: Shopify & Liquid Storefront Engineering
...
- **Project whitelist (dominant):** Glasy.pl, Ascent, Warmsome, Pixel25, Berg's, Diamandia (caveat required). Prefer 4–6; add at most one supporting React e-commerce project if the JD requires React/Next.js **and** Shopify evidence alone is insufficient. Shopify projects must remain the majority (≥75%).
